      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-xl border border-slate-100">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-slate-600">
            Welcome back to Smart Invoice Analyzer
          </p>
        </div>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                type="email"
                required
                className="appearance-none rounded-lg relative block w-full px-3 py-2.5 border border-slate-300 placeholder-slate-400 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors"
